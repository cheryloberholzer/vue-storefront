...
$color-secondary--1: #2c68a0;
$color-secondary--2: #75b4e0;
$color-secondary--3: #2fa61c;
$color-secondary--4: #b50f0f;
$color-secondary--5: #e2951f;
$color-gradient--2-0: #2c68a0;
$color-gradient--2-1: #75b4e0;
$color-status-success: #2fa61c;
$color-status-warning: #e2951f;
$color-status-danger: #b50f0f;
$color-status-info: #75b4e0;
$color-info-label-new-text: #2c68a0;
$color-info-label-new-background: #ffed00;
$color-info-label-promo-background: #b50f0f;
...
header {
  ...
  &::before {
    content: '';
    flex: 1 1 auto;
    background-color: $color-secondary--1; // Attention: Any change here has to be made in the theme-0*.scss file as well.
    display: block; /* IE 11 */
  }
  ...
  &::after {
    content: '';
    flex: 1 1 auto;
    background-color: $color-secondary--2; // Attention: Any change here has to be made in the theme-0*.scss file as well.
    display: block; /* IE 11 */
  }

  .inner {
    position: relative;
    // Attention: Any change in the next line has to be made in the theme-0*.scss file as well.
